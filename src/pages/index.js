...
<main className="flex  items-center text-dark min-h-screen dark:text-light">
    <Layout className='pt-0'>
      <div className="flex items-center justify-between w-full">
        <div className="w-1/2">
          <Image src={selva} alt="profile" className="w-full h-auto" priority
          sizes="(max-width:768px) 100vw,(max-width:1200px) 50vw, 50w"/>
        </div>
        <div className="w-1/2 flex flex-col items-center self-center">
          <AnimatedText text="Where Imagination Meets Implementation" classname="text-6xl !text-left"></AnimatedText>
          <p className="my-4 text-base font-medium">Hi, I'm Selvakumar – a Python and Web Development enthusiast.
...
Aspiring Front-End Developer driven by creativity and continuous learning.
          ...
          <div className="flex items-center self-start mt-2"> 
            ...
            <Link href="mailto:selvakumardurai5973@gmail.com" target={"_blank"}
